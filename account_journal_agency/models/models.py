...
class account_journal(models.Model):
    ...
    @api.v7
    def false_search(self,cr,uid,args, offset=0, limit=None, order=None, context=None, count=False, xtra=None):
        new_args=[]
...
class account_move_line(models.Model):
    ...
    agency_id = fields.Many2one('base.agency',related='journal_id.agency_id',store=True)
